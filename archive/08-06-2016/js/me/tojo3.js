	...
	var tags;
  	$.each(json.items, function(i, item) {
		var geometry = new THREE.PlaneGeometry( 240, 180, 70);
                ...
                //material.color = new THREE.Color(0xffffff, 1);
		//material.depthWrite = false;
		//var material = new THREE.MeshBasicMaterial({ transperant: true });
		//material.color = new THREE.Color(0xffffff, 0.5);
		...
		mesh.position.y += 100;
               	mesh.position.z = -400 * window.background.scene.children.length + 400;		
...
tojo3.prototype.drawScene = function(canvasId) {
	...
	//window.background.renderer.setClearColor(0x000000, 0);
	//window.background.renderer.sortObjects = false;
